                            		...
                            		<div class="tabs-above">
                            			...
                            			<div class="tab-content">
                                            ...
                                            <div id="infos" class="tab-pane'; if($_GET['tab']=='infos' || $_GET['tab']=='') echo 'active'; echo '">
                								...
                								<input style="width:auto;"'.$editable.' class="form-control form-control-sm d-inline-block" name="firstname" type="text" value="' .$user1['firstname'].'" />
                								<div class="space-4"></div>
                								<label for="lastname">'.T_('Nom').' :</label>
												';if($mobile==1) {echo '<br />';} echo '
                								<input style="width:auto;"'.$editable.' class="form-control form-control-sm d-inline-block" name="lastname" type="text" value="'.$user1['lastname'].'" />
                								<div class="space-4"></div>
                                    			<label for="firstname">'.T_('Tutelle').' :</label>
                								<input style="width:auto;"'.$editable.' class="form-control form-control-sm d-inline-block" name="guardianship" type="text" value="'.$user1['firstname_guardianship'].' '.$user1['lastname_guardianship'].'" />
                								<div class="space-4"></div>';
                								...
                								<input style="width:auto;"'.$editable.' class="form-control form-control-sm d-inline-block" autocomplete="off"  name="login" '.$input_type.' value="'.$user1['login'].'"  />
                								<div class="space-4"></div>
                								<label for="password">'.T_('Mot de passe').' :</label>
                								<input style="width:auto;"'.$editable.' class="form-control form-control-sm d-inline-block" autocomplete="new-password" name="password" type="password" value="" />
												<div class="space-4"></div>
                								<label for="password2">'.T_('Confirmation mot de passe').' :</label>
                								<input style="width:auto;"'.$editable.' class="form-control form-control-sm d-inline-block" autocomplete="new-password" name="password2" type="password" value="" />
                								<div class="space-4"></div>
                								';
                								$laboratory = '';
                								...
                								<input style="width:auto;"'.$editable.' class="form-control form-control-sm d-inline-block" name="mail" type="text" value="'.$laboratory.'" />
                								<div class="space-4"></div>
                								<label for="mail">'.T_('Site de rattachement').' :</label>
                								<input style="width:auto;"'.$editable.' class="form-control form-control-sm d-inline-block" name="mail" type="text" value="'.$user1['address1'].'" />                								
                								<div class="space-4"></div>
                								<label for="mail">'.T_('Adresse mail').' :</label>
                								<input style="width:auto;"'.$editable.' class="form-control form-control-sm d-inline-block" name="mail" type="text" value="'.$user1['mail'].'" />                								
                								<div class="space-4"></div>
                								<label for="phone">'.T_('Téléphone fixe').' :</label>
                								<input style="width:auto;"'.$editable.' class="form-control form-control-sm d-inline-block" name="phone" type="text" value="'.$user1['phone'].'" />
                								<div class="space-4"></div>
												<label for="mobile">'.T_('Téléphone portable').' :</label>
                								<input style="width:auto;"'.$editable.' class="form-control form-control-sm d-inline-block" name="mobile" type="text" value="'.$user1['mobile'].'" />
                								<div class="space-4"></div>
                								<label for="fax">'.T_('Fax').' :</label>
												';if($mobile) {echo '<br />';} echo '
                								<input style="width:auto;"'.$editable.' class="form-control form-control-sm d-inline-block" name="fax" type="text" value="'.$user1['fax'].'" />
                								<div class="space-4"></div>
												...
												{
													echo '<select style="width:auto;"'.$editable.' class="form-control form-control-sm d-inline-block" name="service">';
