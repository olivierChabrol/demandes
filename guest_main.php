	...
	<div style="body-container" class="'.$previewMode.'" >
		...
		<div class="main-container">
            ...
            /*/!\NEW*/if($_GET['page']=='ticket' || $_GET['page']=='request') {
						...
						echo '<a href="/"><i class="fa fa-home text-primary-m2"></i></a>
						</div>';
					include "ticket.php";
...
//						elseif($_GET['page']=='dashboard' && $_
//GET['userid']=='%' && $rright['side_all']==0 && $_GET['companyview']==0) {$msg_error=T_("Vous n'avez pas les droits d'accès à la liste de tous les tickets, contacter votre administrateur");}
